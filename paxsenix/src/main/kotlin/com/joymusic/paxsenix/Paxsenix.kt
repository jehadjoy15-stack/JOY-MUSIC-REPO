package com.joymusic.paxsenix

import android.content.Context
import com.joymusic.music.betterlyrics.TTMLParser
import com.joymusic.paxsenix.models.AppleMusicSearchResponse
import com.joymusic.paxsenix.models.LyricsResponse

import com.joymusic.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "JOY MUSIC/$appVersion")
                }
