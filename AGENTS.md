# Working with JOY MUSIC as an AI agent

JOY MUSIC is a 3rd party YouTube Music client written in Kotlin. It follows material 3 design guidelines closely.
...
3. All string edits should be made to the `JOY MUSIC/app/src/main/res/values/JOY MUSIC_strings.xml` file, NOT `JOY MUSIC/app/src/main/res/values/strings.xml`. Do not touch other `strings.xml` or `JOY MUSIC_strings.xml` files in the project. ONLY edit the default (English) `JOY MUSIC_strings.xml` file, DO NOT EDIT OTHER LANGUAGES.
