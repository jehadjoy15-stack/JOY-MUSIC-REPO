...
val baseApplicationId = "com.joymusic.music"
val applicationIdOverride = System.getenv("JOYMUSIC_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = "JOY MUSIC"
val buildCommit =
    System.getenv("JOYMUSIC_BUILD_COMMIT")
        ?.trim()
        ?.takeIf { it.matches(Regex("[0-9a-fA-F]{7,40}")) }
        ?.take(7)
        ?.lowercase()
val debugKeystorePathOverride = System.getenv("JOYMUSIC_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("JOYMUSIC_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("JOYMUSIC_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("JOYMUSIC_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        resValue("string", "app_name", appNameOverride ?: "JOY MUSIC")
        ...
        buildConfigField("Long", "DISCORD_APP_ID", "1541948233973235792L")
    }
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "JOY MUSIC Debug")
            }
            signingConfig =
