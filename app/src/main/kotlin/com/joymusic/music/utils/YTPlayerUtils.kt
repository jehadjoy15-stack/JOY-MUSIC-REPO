...
import com.joymusic.innertube.NewPipeExtractor
...
import com.joymusic.innertube.strategy.ContentAwareFallbackStrategy
import com.joymusic.innertube.strategy.ContentHints
import com.joymusic.music.constants.AudioQuality
import com.joymusic.music.utils.YTPlayerUtils.MAIN_CLIENT
import com.joymusic.music.utils.YTPlayerUtils.validateStatus
import com.joymusic.music.utils.cipher.CipherDeobfuscator
import com.joymusic.music.utils.cipher.FunctionNameExtractor
import com.joymusic.music.utils.cipher.PlayerJsFetcher
import com.joymusic.music.utils.potoken.PoTokenGenerator
import com.joymusic.music.utils.potoken.PoTokenResult
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        if (streamPlayerResponse.playabilityStatus.status != "OK") {
            ...
            // unavailable streams; JOY MUSIC cannot recover those without official playback.
