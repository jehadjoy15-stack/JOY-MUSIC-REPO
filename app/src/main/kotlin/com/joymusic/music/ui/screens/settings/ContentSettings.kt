...
import com.joymusic.music.constants.ContentCountryKey
import com.joymusic.music.constants.ContentLanguageKey
import com.joymusic.music.constants.CountryCodeToName
import com.joymusic.music.constants.EnableBetterLyricsKey
import com.joymusic.music.constants.EnableKugouKey
import com.joymusic.music.constants.EnableLrcLibKey
import com.joymusic.music.constants.EnablePaxsenixKey
import com.joymusic.music.constants.EnableLyricsPlus
...
import com.joymusic.music.constants.LanguageCodeToName
import com.joymusic.music.constants.LyricsProviderOrderKey
import com.joymusic.music.constants.ProxyEnabledKey
import com.joymusic.music.constants.ProxyPasswordKey
import com.joymusic.music.constants.ProxyTypeKey
import com.joymusic.music.constants.ProxyUrlKey
import com.joymusic.music.constants.ProxyUsernameKey
import com.joymusic.music.constants.QuickPicks
import com.joymusic.music.constants.QuickPicksKey
import com.joymusic.music.constants.RandomizeHomeOrderKey
import com.joymusic.music.constants.SYSTEM_DEFAULT
import com.joymusic.music.constants.ShowArtistDescriptionKey
import com.joymusic.music.constants.ShowMostStatsPlaylistsKey
import com.joymusic.music.constants.ShowArtistSubscriberCountKey
import com.joymusic.music.constants.ShowMonthlyListenersKey
import com.joymusic.music.constants.ShowWrappedCardKey
...
import com.joymusic.music.ui.component.DraggableLyricsProviderItem
import com.joymusic.music.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.joymusic.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.joymusic.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.joymusic.music.db.entities.PlaylistEntity(
                        id = com.joymusic.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.joymusic.music.db.entities.PlaylistEntity(
                        id = com.joymusic.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
