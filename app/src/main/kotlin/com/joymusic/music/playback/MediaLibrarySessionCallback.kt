...
import com.joymusic.music.constants.AndroidAutoSearchLocalLimitKey
...
import com.joymusic.music.constants.AndroidAutoSectionsOrderKey
import com.joymusic.music.constants.AndroidAutoYouTubePlaylistsKey
...
import com.joymusic.music.ui.screens.settings.AndroidAutoSection
import com.joymusic.music.ui.screens.settings.deserializeSections
import com.joymusic.music.ui.screens.settings.serializeSections
                ...
                val children = when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.joymusic.innertube.pages.HomePage.Section>()
