...
# Since JOY MUSIC is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.joymusic.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.joymusic.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep all JOY MUSIC project classes
-keep class com.joymusic.** { *; }
-keep class com.dpi.** { *; }
-dontwarn com.joymusic.**
-dontwarn com.dpi.**

# Keep streaming utility classes
-keep class com.joymusic.music.utils.cipher.** { *; }
-keep class com.joymusic.music.utils.potoken.** { *; }
...
-keep class com.joymusic.music.models.PersistQueue { *; }
-keep class com.joymusic.music.models.PersistPlayerState { *; }
-keep class com.joymusic.music.models.QueueData { *; }
-keep class com.joymusic.music.models.QueueType { *; }
-keep class com.joymusic.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.joymusic.music.cast.** { *; }
...
-keep class com.joymusic.music.recognition.VibraSignature { *; }
-keepclassmembers class com.joymusic.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.joymusic.music.listentogether.proto.** { *; }
-keepclassmembers class com.joymusic.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.joymusic.shazamkit.models.** { *; }
-keepclassmembers class com.joymusic.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.joymusic.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.joymusic.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.joymusic.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
